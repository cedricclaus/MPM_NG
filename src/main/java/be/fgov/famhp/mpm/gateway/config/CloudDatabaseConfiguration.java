package be.fgov.famhp.mpm.gateway.config;
...
@Configuration
@EnableMongoRepositories("be.fgov.famhp.mpm.gateway.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("be.fgov.famhp.mpm.gateway.config.dbmigrations");
