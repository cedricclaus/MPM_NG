...
import be.fgov.famhp.mpm.gateway.config.Constants;

import be.fgov.famhp.mpm.gateway.MpmNgApp;
import be.fgov.famhp.mpm.gateway.domain.Authority;
import be.fgov.famhp.mpm.gateway.domain.User;
import be.fgov.famhp.mpm.gateway.repository.AuthorityRepository;
import be.fgov.famhp.mpm.gateway.repository.UserRepository;
import be.fgov.famhp.mpm.gateway.security.AuthoritiesConstants;
import be.fgov.famhp.mpm.gateway.service.MailService;
import be.fgov.famhp.mpm.gateway.service.UserService;
import be.fgov.famhp.mpm.gateway.service.dto.UserDTO;
import be.fgov.famhp.mpm.gateway.web.rest.vm.KeyAndPasswordVM;
import be.fgov.famhp.mpm.gateway.web.rest.vm.ManagedUserVM;
